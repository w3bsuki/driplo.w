...
{#if isVisible}
  ...
  >
    ...
    <div class="sticky top-0 bg-white z-10 border-b border-gray-100">
      <div class="flex items-center justify-between p-4">
        <div class="flex items-center gap-3">
          <button
            onclick={onClose}
            class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center select-none [touch-action:manipulation] [-webkit-tap-highlight-color:transparent]"
            aria-label="Close"
          >
        ...
        <div class="flex items-center gap-2">
          <button
            ...
            class="text-sm text-blue-600 font-medium select-none [touch-action:manipulation] [-webkit-tap-highlight-color:transparent]"
          >
      ...
      <div class="sticky top-16 bg-white z-10 border-b border-gray-100">
        <div class="flex">
          {#each ['info', 'condition', 'seller'] as section}
            <button
              onclick={() => currentSection = section as 'info' | 'condition' | 'seller'}
              class="flex-1 py-3 px-4 text-sm font-medium capitalize transition-colors motion-reduce:transition-none select-none [touch-action:manipulation] [-webkit-tap-highlight-color:transparent]
    ...
    <div class="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 pt-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
      <div class="flex gap-3">
        <!-- Make Offer Button -->
        <button
          onclick={onMakeOffer}
          class="flex-1 bg-gray-100 text-gray-900 font-semibold py-3 px-4 rounded-xl transition-colors motion-reduce:transition-none sm:hover:bg-gray-200 select-none [touch-action:manipulation] [-webkit-tap-highlight-color:transparent]"
        >
          Make Offer
        </button>
        ...
        <button
          onclick={onBuyNow}
          class="flex-2 bg-black text-white font-semibold py-3 px-6 rounded-xl transition-colors motion-reduce:transition-none sm:hover:bg-gray-800 disabled:opacity-50 select-none [touch-action:manipulation] [-webkit-tap-highlight-color:transparent]"
