...
<div class="min-h-screen bg-gray-50 pb-20 sm:pb-0">
	...
	{#if showCompactSearch}
		<div class="fixed top-14 sm:top-16 left-0 right-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm pt-[max(0.25rem,env(safe-area-inset-top))]">
		...
		<div bind:this={heroSearchElement} class="bg-gray-50 border-b border-gray-200">
			<div class="px-4 sm:px-6 lg:px-8 py-4 space-y-3">
				...
				{#if !showCategoryDropdown}
					...
					<button 
						onclick={() => goto('/search')}
						class="category-nav-pill flex-shrink-0 px-5 py-2.5 bg-black text-white rounded-xl text-sm font-semibold sm:hover:bg-gray-900"
					>
						{i18n.search_all()}
					</button>
					{#each mainCategories as category}
						<button 
							...
							class="category-nav-pill flex-shrink-0 px-5 py-2.5 bg-white border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 sm:hover:bg-gray-50 sm:hover:border-gray-300"
						>
									...
									<div class="space-y-1">
										{#each [i18n.home_trending_vintageJackets(), i18n.home_trending_y2kJeans(), i18n.home_trending_designerBagsUnder100()] as trend}
											<button
												...
												class="w-full text-left px-3 py-2 text-sm text-gray-700 rounded-lg flex items-center space-x-2 sm:hover:bg-white/60"
											>
									...
									<div class="space-y-1">
										{#each sellers.slice(0, 3) as seller}
											<button
												...
												class="w-full text-left px-3 py-2 text-sm text-gray-700 rounded-lg flex items-center space-x-3 sm:hover:bg-white/60"
											>
